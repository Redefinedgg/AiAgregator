...
export const TOKEN_PRICES_GPT_3_5_TURBO = {
  prompt: 0.5 / 1_000_000,    // $0.50 за 1M токенов (ввод)
  completion: 1.5 / 1_000_000, // $1.50 за 1M токенов (вывод)
  markup: 10,
};

export const TOKEN_PRICES_GPT_4O_MINI = {
  prompt: 0.15 / 1_000_000,    // $0.15 за 1M токенов
  completion: 0.6 / 1_000_000, // $0.60 за 1M токенов
  markup: 10,
};

// Anthropic
export const TOKEN_PRICES_CLAUDE_SONNET_4_0 = {
  prompt: 3 / 1_000_000,       // $3.00 за 1M токенов
  completion: 15 / 1_000_000,   // $15.00 за 1M токенов
  markup: 10,
};

// DeepSeek (только Chat)
export const TOKEN_PRICES_DEEPSEEK_CHAT = {
  prompt: 0.27 / 1_000_000,    // $0.27 за 1M токенов (cache miss)
  completion: 1.10 / 1_000_000, // $1.10 за 1M токенов
  markup: 10,
